...
void fillup_save(uint8_t* Buffer, char num, unsigned char life, unsigned char Map_x, unsigned char Map_y, unsigned short Location_x, unsigned short Location_y, char score)
{
